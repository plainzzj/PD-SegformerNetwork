...
class ZZJPointHead(BaseCascadeDecodeHead):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(ZZJPointHead, self).__init__(
        ...
        # TODO 11.18 by Zhijia Zhu
        # change fc_in_channels: 1024+2 -> 512+2! ->B0
        fc_in_channels = sum(self.in_channels) + self.num_classes  # ->B2
        # fc_in_channels = sum(self.in_channels)//2 + self.num_classes  # ->B0
    ...
    def forward_train(self, inputs, prev_output, img_metas, gt_semantic_seg,
        ...
        """
        # TODO changed 2022.11.18 by Zhijia Zhu
        prev_output_list = prev_output  # list[Tensor]
        prev_output = prev_output[-1]  # Tensor
    ...
    def get_points_train(self, seg_logits, uncertainty_func, cfg):
        ...
        Returns:
            point_coords (Tensor): A tensor of shape (batch_size, num_points,
                ...
                points.
        """
        # TODO changed 2022.11.17 by Zhijia Zhu
        ###############################
        ## K-Net seg_logits ->[list] ##
