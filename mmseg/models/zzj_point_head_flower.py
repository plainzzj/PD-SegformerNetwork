...
class ZZJPointHeadFlower(BaseCascadeDecodeHead):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(ZZJPointHeadFlower, self).__init__(
        ...
        # change fc_in_channels: 1024+2 -> 512+2!
        # TODO 12.19 by Zhijia Zhu
        # fc_in_channels = sum(self.in_channels) + self.num_classes
        fc_in_channels = sum(self.in_channels)//4 + self.num_classes
