...
data_root = 'data/zzj_flower_small/zzj_flower_small'
img_norm_cfg = dict(
...
train_pipeline = [
    ...
    dict(
        ...
        to_rgb=True),
    dict(type='Pad', size=(800, 800), pad_val=0, seg_pad_val=255),
...
model = dict(
    ...
    test_cfg=dict(
        ...
        scale_factor=2))
work_dir = './work_dirs/final_OURS_B2_32K_FLOWERS_fixCheckpoint'
gpu_ids = range(0, 4)
auto_resume = False
